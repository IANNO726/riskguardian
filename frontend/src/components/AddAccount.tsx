...
const AddAccount: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(`Account "${response.data.account_name}" added successfully! �œ…`);
                  ...
                  <Grid item xs={12}>
                    <Alert severity="info" sx={{ borderRadius: '12px', mb: 2 }}>
                      <Typography sx={{ fontSize: '13px' }}>
                        �Ÿ”’ Your credentials are encrypted and stored securely. We use industry-standard encryption to protect your data.
                      </Typography>
                    </Alert>
                  </Grid>
